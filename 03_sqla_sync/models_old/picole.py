...
class Picole(ModelBase):
    ...
    conservantes: Optional[List[Ingrediente]] = orm.relationship('Conservante', secondary=conservantes_picole, backref='conservante', lazy='joined')
    ...
    def __repr__(self):
        return f'<Picole: {self.tipo_picole.nome} com sabor {self.sabor.nome}>'
